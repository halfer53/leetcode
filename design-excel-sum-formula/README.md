<h2>631. Design Excel Sum Formula</h2><h3>Hard</h3><hr><div><p>Design the basic function of <strong>Excel</strong> and implement the function of the sum formula.</p>
